    ...
    <div id="dashboard">
        ...
        <div class="table_frame">
            ...
            <table>
                ...
                <tr v-bind:key="item.id" v-for="(item) in items">
                    <td>{{item.id}}</td>
                    <td>{{item.img_name}}</td>
                    <td v-on:click="show_image_on_modal('/org/'+item.img_name)"><img v-bind:src="'http://localhost:5002/org/' + item.img_name" height="100px"></td>
                    <td v-on:click="show_image_on_modal('/cam/'+item.img_name)"><img v-bind:src="'http://localhost:5002/cam/' + item.img_name" height="100px"></td>
        ...
        <modal :val="showImgName"
          ...
          <div class="modal_window">    
            <!-- <h3>拡大画像</h3> -->
            <img v-bind:src="'http://localhost:5002/'  + showImgName" height="380px">
          </div>
        </modal>
...
<script>
// var endpoint_base = "http://localhost:5002"
...
export default {
    ...
    data(){
        return {
            ...
            showImgName : "",
            onlyCheckFlag : false,
            newItem : {"title" : "", "auther" : "", "publish": "", "evaluate": "", "category": "","read": 0},
            changeItem : { "id" : "", propaty : "", content : "" },
            deleteID : "",
        }
    },
    mounted(){
